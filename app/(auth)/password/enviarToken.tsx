...
import { EnviarTokenRecuperacaoDeSenha } from '@/app/Services/RecuperacaoDeSenhaServices';

export default function EnviarTokenResetarSenha() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const data = {
                OPtoken: selectedId as string
            }
    
            const response = await EnviarTokenRecuperacaoDeSenha(data);
            ...
            if(response.status === 200) {
                ...
                router.push({
                    pathname: "/password/validarCodigo",
                    params: {
                        tipoContato: tipo,
                        contato: contato
                    }
