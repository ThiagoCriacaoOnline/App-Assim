...
import { ValidarTokenRecuperacaoDeSenha } from '@/app/Services/RecuperacaoDeSenhaServices';
import { useLocalSearchParams, useRouter } from 'expo-router';

export default function ValidarCodigoRecuperacaoDeSenha() {
const router = useRouter();
    ...
    const handleSubmit = async () => {
        ...
        try{
            ...
            const response = await ValidarTokenRecuperacaoDeSenha(data);
